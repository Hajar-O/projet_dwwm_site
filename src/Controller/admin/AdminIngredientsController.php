...
class AdminIngredientsController extends AbstractController
{
    ...
    public function listIngredients(IngredientRepository $ingredientsRepository)
    {
    ...
    public function deleteIngredients(IngredientRepository $ingredientsRepository, int $id, EntityManagerInterface $entityManager)
    {
    ...
    public function insertIngredients(IngredientRepository $ingredientsRepository, Request $request, EntityManagerInterface $entityManager, ValidatorInterface $validator )
    {
    ...
    public function upDateIngredients( int $id,IngredientRepository $ingredientsRepository ,Request $request, EntityManagerInterface $entityManager)
    {
